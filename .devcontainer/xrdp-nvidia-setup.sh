...
usermod $USER -a -G video
usermod $USER -a -G tty
#usermod $USER -a -G render

# XRDP Build Pre-reqs Part 1
apt-get -y install git autoconf libtool pkg-config gcc g++ make \
...
#System Pre-reqs
apt-get -y install xorg xserver-xorg-legacy dbus-x11
apt-get -y remove dbus-user-session
